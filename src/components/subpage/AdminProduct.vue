...
const columns = [
  ...
  { name: 'Keyword', label: 'Keyword', field: 'keyword', align: 'center' },
  { name: 'Guarantee', label: 'Guarantee', field: 'guarantee', align: 'center' },
  { name: 'Color', label: 'Color', field: 'color', sortable: true, align: 'center', sort: (a, b) => parseInt(a, 10) - parseInt(b, 10) },
  { name: 'Mounts', label: 'Mounts', field: 'mounts', sortable: true, sort: (a, b) => parseInt(a, 10) - parseInt(b, 10), align: 'center' },
